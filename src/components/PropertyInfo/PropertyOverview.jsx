...
export default function PropertyOverview({ data }) {
  ...
  return (
    <div className="property-overview-section">
      ...
      {/* Host Preview Row matching original1.png */}
      ...
      {/* Key Highlights with exact Airbnb icons matching original1.png */}
      ...
      {/* Listing Description matching PlanYourHolidayShowMore.png and PlanYourHolidayShowLess.png */}
      <div className="prop-description-block">
        ...
        <p
          className={`description-paragraph ${!showFullDesc ? 'description-paragraph-clamped' : ''}`}
          id="descText"
        >
        ...
        >
          <span className="show-more-text">{showFullDesc ? 'Show less' : 'Show more'}</span>
          <span className="show-more-ico" style={{ display: 'flex', width: 14, height: 14 }}>
